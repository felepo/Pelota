...
/**
 * Created by fernando on 4/12/17.
 */
...
public class Partida extends ImageView
{
    ...
    public Partida(Context contexto, int nivel_dificultad)
    {
        ...
        WindowManager manejador_ventana=(WindowManager) contexto
                .getSystemService(Context.WINDOW_SERVICE);
        Display pantalla=manejador_ventana.getDefaultDisplay();

        Point maneja_coord=new Point(); //Integra dos coordenadas x,y de la pantalla
        pantalla.getSize(maneja_coord); //Se obtiene el tamaño de la pantalla.

        tam_pantX=maneja_coord.x;
        tam_pantY=maneja_coord.y;

        //Construye un layout programatico para el fondo
        BitmapDrawable dibujo_fondo=(BitmapDrawable) ContextCompat
                .getDrawable(contexto, R.drawable.paisaje_1);
        ...
        //Se hace lo mismo con la pelota
        BitmapDrawable objetoPelota=(BitmapDrawable)ContextCompat
                .getDrawable(contexto, R.drawable.pelota_1);
        ...
        //la velocidad de la pelota depende de la dificultad
